...
class RegistrationController extends AbstractController
{
    ...
    ): Response    
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) 
        {
            ...
            $sendEmailService->send([
                "sender_email"         => "playlistbb@gmail.com",
                "sender_name"          => "Ben Bala",
                "recipient_email"      => $user->getEmail(),
                "subject"              => "Vérification de votre compte sur le site Playlist ♫",
    ...
    public function emailVerif(User $user, string $token, UserRepository $userRepository) : Response
    {
        ...
        {
            $this->addFlash('success', "Votre compte a dejà été vérifie! Veuillez vous connecter.");
            return $this->redirectToRoute('visitor.welcome.index');
        }
